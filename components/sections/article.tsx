        ...
        <div className="flex w-full px-2x pb-4x pt-5x md:sticky md:-top-[200px] md:h-[500px] md:p-4x">
          <div className="mt-auto flex flex-col gap-1x">
            <div className="flex gap-2x">
              <div className="flex h-6x w-6x rounded-full bg-background-dark-sand">
                <p className="text-heading-4xs m-auto text-text-black">
                  {authorInitials}
                </p>
              </div>
              <div className="my-auto flex flex-col">
                <p className="text-heading-3xs text-text-light-gray">
            ...
            <div className="flex w-full flex-col gap-1x md:gap-1x">
              <h1 className="text-heading-md text-heading-sm">
                {article.title}
              </h1>
              <p className="text-body-sm">{article.excerpt}</p>
            </div>
          </div>
        </div>
      </div>
